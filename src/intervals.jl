...
get_points_samp_length(mesh::FixedIntervalsMesh) = get_points_samp_length(mesh.bounds_mesh)
...
get_points_samp_length(mesh::FlexibleIntervalsMesh) = get_points_samp_length(mesh.fixed)
